...
\vbox to \paperheight{
\vfill
\includegraphics[width=\paperwidth]{background_clumps_5.pdf} %your picture
    }%
}
...
%\vspace*{1.9cm}
%\hspace*{5.5cm}
%\includemovie{0.54\columnwidth}{0.5\columnwidth}{clumps_all.mp4}%
%\end{frame}

\begin{frame}
\vspace*{1.9cm}
\hspace*{5.5cm}
\includemovie{0.54\columnwidth}{0.5\columnwidth}{clumps_zoom.mp4}%
\end{frame}

...
\vbox to \paperheight{
\vfill
\includegraphics[width=\paperwidth]{background_clumps_v3.png} %your picture
    }%
}
...
\column{0.5\textwidth}
\begin{center}%
    \includemovie{\columnwidth}{\columnwidth}{clumps_all.mp4}%
\end{center}%
\column{0.5\textwidth}
\begin{center}%
    \includemovie{\columnwidth}{\columnwidth}{clumps_HR.mp4}%
\end{center}%
\end{columns}
\end{frame}
...
\column{0.5\textwidth}
\begin{center}%
    \includemovie{\columnwidth}{\columnwidth}{clumps_zoom.mp4}%
\end{center}%
\end{columns}
\end{frame}

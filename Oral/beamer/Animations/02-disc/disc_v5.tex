...
\vbox to \paperheight{
\vfill
\includegraphics[width=\paperwidth]{background_disc_5.pdf} %your picture
    }%
}
...
%\vspace*{3.2cm}
%\hspace*{3.8cm}
%\includemovie{0.69\columnwidth}{0.48\columnwidth}{highS_opt.mp4}%
%\end{frame}
%
%\begin{frame}
%\vspace*{3.2cm}
%\hspace*{3.9cm}
%\includemovie{0.7\columnwidth}{0.47\columnwidth}{highS_opt.mp4}%
%\end{frame}
%
%\begin{frame}
%\vspace*{3.2cm}
...
%\vspace*{3.2cm}
%\hspace*{3.8cm}
%\includemovie{0.7\columnwidth}{0.48\columnwidth}{highS_opt.mp4}%
%\end{frame}
